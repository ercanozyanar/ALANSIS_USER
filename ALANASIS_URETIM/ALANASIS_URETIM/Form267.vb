...
Public Class Form267
    ...
    Sub New()
        ...
        EO_ALANSIS_SARFHAR_BAKTableAdapter1.Fill(AlansısDataSet692.EO_ALANSIS_SARFHAR_BAK)

    End Sub
    Private Sub Form267_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            cmd.CommandText = "SELECT TARIH,NO,SARF_ADI,TIP,MIKTAR,HAREKET_KODU FROM EO_ALANSIS_DEPO_SARFHAR "
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        ...
        For Each i As Integer In GridView1.GetSelectedRows()
            ...
            recetefire = 0
            toptuketim = 0
            recetestok = row("SARF_ADI")
            recetemiktar = row("SARF")
            toptuketim = recetemiktar
            ListBox1.Items.Add(row("SARF_ADI"))
        ...
        If listkontrol > 0 Then
            ...
            For i As Integer = 0 To ListBox1.Items.Count - 1 And ListBox2.Items.Count - 1
                ...
                cmd1.CommandText = "INSERT INTO EO_ALANSIS_DEPO_SARFHAR (TARIH,NO,SARF_ADI,TIP,MIKTAR,HAREKET_KODU,SUBE,DEPO_KODU) VALUES ('" & DateTime.Now & "','" & SRFSK & "', '" & sonstok & "','SARF', '" & Replace(sonmiktar, ",", ".") & "','C','ALASEHIR','65')"
        ...
        cmd.Connection = cnn
        cmd.CommandType = CommandType.Text
        cmd.CommandText = "SELECT TARIH,NO,SARF_ADI, TIP,MIKTAR HAREKET_KODU FROM EO_ALANSIS_DEPO_SARFHAR ORDER BY ID DESC"
        da.SelectCommand = cmd
        DataGridView1.ClearSelection()
        da.Fill(ds)
        DataGridView1.DataSource = ds.Tables(0).DefaultView
