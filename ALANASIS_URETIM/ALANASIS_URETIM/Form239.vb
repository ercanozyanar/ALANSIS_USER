...
Public Class Form239
    ...
    Dim i As Integer
    Private Sub Form239_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            cmd.CommandText = "SELECT ID,DURUM,SIPARIS_TURU,PARTI,MUSTERI,SATIS_ONAY,URETIM_ONAY FROM EO_ALANSIS_SATIS WHERE SATIS_ONAY='OK' AND URETIM_ONAY='OK' AND DURUM NOT LIKE 'İptal'"
    ...
    Private Sub TextEdit1_EditValueChanged(sender As Object, e As EventArgs) Handles TextEdit1.EditValueChanged
        ...
        Try
            ...
            cmd.Connection = cnn
            cmd.CommandType = CommandType.Text
            cmd.CommandText = "SELECT ID,DURUM,SIPARIS_TURU,PARTI,MUSTERI,SATIS_ONAY,URETIM_ONAY FROM EO_ALANSIS_SATIS WHERE PARTI LIKE '%" & TextEdit1.Text & "%' AND (SATIS_ONAY='OK' AND URETIM_ONAY='OK' AND DURUM NOT LIKE 'İptal')"
            da.SelectCommand = cmd
            DataGridView1.ClearSelection()
            da.Fill(ds)
            DataGridView1.DataSource = ds.Tables(0).DefaultView
    ...
    Private Sub TextEdit3_EditValueChanged(sender As Object, e As EventArgs) Handles TextEdit3.EditValueChanged
        ...
        Try
            ...
            cmd.Connection = cnn
            cmd.CommandType = CommandType.Text
            cmd.CommandText = "SELECT ID,DURUM,SIPARIS_TURU,PARTI,MUSTERI,SATIS_ONAY,URETIM_ONAY FROM EO_ALANSIS_SATIS WHERE MUSTERI LIKE '%" & TextEdit3.Text & "%' AND  (SATIS_ONAY='OK' AND URETIM_ONAY='OK' AND DURUM NOT LIKE 'İptal')"
            da.SelectCommand = cmd
            DataGridView1.ClearSelection()
            da.Fill(ds)
            DataGridView1.DataSource = ds.Tables(0).DefaultView
    ...
    Private Sub DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        partino = DataGridView1.CurrentRow.Cells(4).Value.ToString()
        '------------------------------------------------------------------------------------------------------------------------------
        ...
        While reader1.Read()
            Form131.TextBox2.Text = reader1("ID")
        ...
        Form131.ComboBoxEdit16.Enabled = False
        '=============================================================================================================================
        Form131.SimpleButton1.Enabled = True
        Form131.ComboBoxEdit1.Enabled = True
        Form131.SimpleButton2.Enabled = True
        Form131.SimpleButton4.Enabled = False
        Form131.SimpleButton5.Enabled = False
        '=============================================================================================================================
        Me.Hide()
