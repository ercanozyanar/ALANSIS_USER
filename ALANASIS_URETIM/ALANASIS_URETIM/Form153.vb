...
Public Class Form153
    ...
    Private Sub ComboBoxEdit1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBoxEdit1.SelectedIndexChanged
        ...
        '=====================================================================================================
        SqlConn.Open()
        Dim mySelectQuery1 As String = "SELECT STOK_KODU,(SELECT ISNULL(SUM(MIKTAR),0) AS GIRIS FROM EO_ALANSIS_HAMHAR WHERE STOK_KODU='" & TextBox1.Text & "' AND HARAKET_KODU='G' AND DEPO_KODU='30') AS GIRIS_BAKIYE FROM EO_ALANSIS_HAMHAR WHERE STOK_KODU='" & TextBox1.Text & "' AND DEPO_KODU='30' GROUP BY STOK_KODU;"
        ...
        '=====================================================================================================
        SqlConn.Open()
        Dim mySelectQuery2 As String = "SELECT STOK_KODU,(SELECT ISNULL(SUM(MIKTAR),0) AS CIKIS FROM EO_ALANSIS_HAMHAR WHERE STOK_KODU='" & TextBox1.Text & "' AND HARAKET_KODU='C' AND DEPO_KODU='30') AS CIKIS_BAKIYE FROM EO_ALANSIS_HAMHAR WHERE STOK_KODU='" & TextBox1.Text & "' AND DEPO_KODU='30' GROUP BY STOK_KODU;"
        ...
        Try
            ...
            cmd.CommandText = "SELECT TARIH,STOK_KODU,STOK_ADI,BELGENO,HARAKET_TIPI,CASE HARAKET_KODU WHEN 'C' THEN 'CIKIS' WHEN 'G' THEN 'GIRIS' END AS HARAKET_TIPI,MIKTAR,GELDIGI_YER,RENK,DEPO_KODU FROM EO_ALANSIS_HAMHAR WHERE STOK_KODU='" & TextBox1.Text & "' AND DEPO_KODU='30'"
    ...
    Private Sub DataGridView1_CellContentDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentDoubleClick
        Form154.TextBox1.Text = DataGridView1.CurrentRow.Cells(3).Value.ToString
        Form154.Show()
    End Sub
