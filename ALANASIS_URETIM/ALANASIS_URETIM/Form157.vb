...
Public Class Form157
    ...
    Private Sub RadioButton2_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RadioButton2.CheckedChanged
        ...
        '===========================================================================================================================================================================================================
        Dim connectionString As String = "server=10.3.11.61;database=ALANSIS;uid=sa;pwd=term.0907"
        Dim sql As String = "SELECT TARIH,[NO] AS HAREKET_NO,SARF_ADI,(CASE HAREKET_KODU WHEN 'C' THEN 'CIKIS' WHEN 'G' THEN 'GIRIS' END) AS HAREKET_TIPI,MIKTAR,BOLGE,DEPO_KODU FROM EO_ALANSIS_DEPO_SARFHAR WHERE SARF_ADI='" & ComboBox1.Text & "' AND SUBE='" & TextBox4.Text & "' AND DEPO_KODU='" & TextBox3.Text & "' ORDER BY ID ASC"
        Dim connection As New SqlConnection(connectionString)
        Dim dataadapter As New SqlDataAdapter(sql, connection)
        Dim ds As New DataSet()
        connection.Open()
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        ...
        ElseIf result = DialogResult.Yes Then
            ...
            cmd1.CommandText = "INSERT INTO EO_ALANSIS_DEPO_SARFHAR (TARIH,NO, SARF_ADI, TIP, MIKTAR, HAREKET_KODU,SUBE,DEPO_KODU) VALUES ('" & DateTime.Now & "', '" & numara1 & "','" & ComboBox1.Text & "', 'SAYIM','" & deger & "'  ,'" & hareket_kodu & "','" & TextBox4.Text & "','" & TextBox3.Text & "')"
            cmd1.ExecuteNonQuery()
            '--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
            conn1.Close()
            '===========================================================================================================================================================================================================
            Dim connectionString As String = "server=10.3.11.61;database=ALANSIS;uid=sa;pwd=term.0907"
            Dim sql As String = "SELECT TARIH,[NO] AS HAREKET_NO,SARF_ADI,(CASE HAREKET_KODU WHEN 'C' THEN 'CIKIS' WHEN 'G' THEN 'GIRIS' END) AS HAREKET_TIPI,MIKTAR,BOLGE FROM EO_ALANSIS_DEPO_SARFHAR WHERE SARF_ADI='" & ComboBox1.Text & "' AND SUBE='" & TextBox4.Text & "' AND DEPO_KODU='" & TextBox3.Text & "' ORDER BY ID ASC"
            Dim connection As New SqlConnection(connectionString)
            Dim dataadapter As New SqlDataAdapter(sql, connection)
            Dim ds As New DataSet()
            connection.Open()
            ...
            '---------------------------------------------------------------------------------------------------------------
            cnn.Open()
            Dim mySelectQuery6 As String = "SELECT* FROM EO_ALANSIS_SARFHAR_TGIR WHERE SARF_ADI= '" & ComboBox1.Text & "' AND SUBE='" & TextBox4.Text & "' AND DEPO_KODU='" & TextBox3.Text & "';"
            Dim SqlComm6 As New System.Data.SqlClient.SqlCommand(mySelectQuery6, cnn)
            Dim reader6 = SqlComm6.ExecuteReader()
            While reader6.Read()
                TextEdit1.Text = reader6("TGIRIS").ToString()
            ...
            '---------------------------------------------------------------------------------------------------------------
            cnn.Open()
            Dim mySelectQuery7 As String = "SELECT* FROM EO_ALANSIS_SARFHAR_TCIK WHERE SARF_ADI= '" & ComboBox1.Text & "' AND SUBE='" & TextBox4.Text & "' AND DEPO_KODU='" & TextBox3.Text & "';"
            Dim SqlComm7 As New System.Data.SqlClient.SqlCommand(mySelectQuery7, cnn)
            Dim reader7 = SqlComm7.ExecuteReader()
            While reader7.Read()
                TextEdit2.Text = reader7("TCIKIS").ToString()
    ...
    Private Sub SimpleButton2_Click(sender As Object, e As EventArgs) Handles SimpleButton2.Click
        ...
        ElseIf result = DialogResult.Yes Then
            ...
            conn1.Open()
            cmd1.Connection = conn1
            cmd1.CommandText = "INSERT INTO EO_ALANSIS_DEPO_SARFHAR (TARIH,NO, SARF_ADI, TIP, MIKTAR, HAREKET_KODU,SUBE,DEPO_KODU) VALUES ('" & DateTime.Now & "', '" & datnumara & "','" & ComboBox1.Text & "', 'DAT','" & dat_miktar & "'  ,'C','" & TextBox4.Text & "','" & TextBox5.Text & "')"
            cmd1.ExecuteNonQuery()
            conn1.Close()
            conn1.Open()
            cmd1.Connection = conn1
            cmd1.CommandText = "INSERT INTO EO_ALANSIS_DEPO_SARFHAR (TARIH,NO, SARF_ADI, TIP, MIKTAR, HAREKET_KODU,SUBE,DEPO_KODU) VALUES ('" & DateTime.Now & "', '" & datnumara & "','" & ComboBox1.Text & "', 'DAT','" & dat_miktar & "'  ,'G','" & TextBox4.Text & "','" & TextBox6.Text & "')"
            cmd1.ExecuteNonQuery()
            conn1.Close()
            '---------------------------------------------------------------------------------------------------
            MsgBox("İslem Tamamlandı...")
            ...
            Try
                ...
                cmd.Connection = cnn
                cmd.CommandType = CommandType.Text
                cmd.CommandText = "SELECT TARIH,[NO] AS HAREKET_NO,SARF_ADI,(CASE HAREKET_KODU WHEN 'C' THEN 'CIKIS' WHEN 'G' THEN 'GIRIS' END) AS HAREKET_TIPI,MIKTAR,BOLGE FROM EO_ALANSIS_DEPO_SARFHAR WHERE SARF_ADI='" & ComboBox1.Text & "' AND SUBE='" & TextBox4.Text & "' AND DEPO_KODU='" & TextBox3.Text & "' ORDER BY ID ASC"
                da.SelectCommand = cmd
                da.Fill(ds)
                DataGridView1.DataSource = ds.Tables(0).DefaultView
                DataGridView1.Columns(0).Width = 150
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        '    cmd.Connection = cnn
        '    cmd.CommandType = CommandType.Text
        '    cmd.CommandText = "SELECT TARIH,[NO] AS HAREKET_NO,SARF_ADI,(CASE HAREKET_KODU WHEN 'C' THEN 'CIKIS' WHEN 'G' THEN 'GIRIS' END) AS HAREKET_TIPI,MIKTAR,BOLGE FROM EO_ALANSIS_DEPO_SARFHAR WHERE SARF_ADI='" & ComboBox1.Text & "' AND SUBE='" & TextBox4.Text & "' AND DEPO_KODU='10' ORDER BY ID ASC"
        '    da.SelectCommand = cmd
        '    da.Fill(ds)
        '    DataGridView1.DataSource = ds.Tables(0).DefaultView
        '    DataGridView1.Columns(0).Width = 150
    ...
    Private Sub ComboBoxEdit1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBoxEdit1.SelectedIndexChanged
        ...
        '===========================================================================================================================================================================================================
        Dim connectionString As String = "server=10.3.11.61;database=ALANSIS;uid=sa;pwd=term.0907"
        Dim sql As String = "SELECT TARIH,[NO] AS HAREKET_NO,SARF_ADI,(CASE HAREKET_KODU WHEN 'C' THEN 'CIKIS' WHEN 'G' THEN 'GIRIS' END) AS HAREKET_TIPI,MIKTAR,BOLGE,DEPO_KODU FROM EO_ALANSIS_DEPO_SARFHAR WHERE SUBE='" & TextBox4.Text & "' AND DEPO_KODU='" & TextBox3.Text & "'  ORDER BY ID ASC"
        Dim connection As New SqlConnection(connectionString)
        Dim dataadapter As New SqlDataAdapter(sql, connection)
        Dim ds As New DataSet()
        connection.Open()
