...
Public Class Form235
    ...
    Private Sub Form235_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            cmd.CommandText = "SELECT* FROM EO_ALANSIS_FATONAY WHERE ONAY IS NULL"
    ...
    Private Sub DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        reader1.Close()
        conn1.Close()
        Form234.ComboBoxEdit1.Enabled = True
        Form234.TextBox1.Text = "1"
