...
Public Class Form90
    ...
    Private Sub Form90_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            cmd.CommandText = "SELECT* FROM EO_ALANSIS_KIVISARFFIRE;"
    ...
    Private Sub ComboBox2_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox2.SelectedIndexChanged
        ...
        Try
            ...
            cmd.Connection = cnn
            cmd.CommandType = CommandType.Text
            cmd.CommandText = "SELECT* FROM EO_ALANSIS_KIVISARFFIRE WHERE [NO]='" & ComboBox2.Text & "';"
            da.SelectCommand = cmd
            da.Fill(ds)
            DataGridView1.DataSource = ds.Tables(0).DefaultView
        Catch ex As Exception
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        ...
        Try
            ...
            cmd.Connection = cnn
            cmd.CommandType = CommandType.Text
            cmd.CommandText = "SELECT* FROM EO_ALANSIS_KIVISARFFIRE WHERE WHERE [NO]='" & ComboBox2.Text & "'AND SARF_ADI LIKE '%" & TextBox1.Text & "%'"
            da.SelectCommand = cmd
            da.Fill(ds)
            DataGridView1.DataSource = ds.Tables(0).DefaultView
        Catch ex As Exception
    ...
    Private Sub DataGridView1_CellContentDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentDoubleClick
        Form91.TextBox1.Text = DataGridView1.CurrentRow.Cells(1).Value.ToString
        Form91.TextBox2.Text = ComboBox2.Text
        Form91.Show()
    End Sub
