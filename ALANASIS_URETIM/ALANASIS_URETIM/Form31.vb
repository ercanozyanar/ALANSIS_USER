...
Public Class Form31
    ...
    Private Sub Form31_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '-----------------------------------------------------------------------------------------
        cnn.Open()
        Dim mySelectQuery2 As String = "SELECT YIL FROM EO_ALANSIS_HAFTA_URETIM1 GROUP BY YIL;"
        ...
        While reader2.Read()
            ComboBox2.Items.Add(reader2("YIL"))
        End While
        reader2.Close()
        cnn.Close()
        '-----------------------------------------------------------------------------------------
        '-----------------------------------------------------------------------------------------
        cnn.Open()
        Dim mySelectQuery1 As String = "SELECT HAFTA FROM EO_ALANSIS_HAFTA_URETIM1 GROUP BY HAFTA;"
        Dim SqlComm1 As New System.Data.SqlClient.SqlCommand(mySelectQuery1, cnn)
        Dim reader1 As System.Data.SqlClient.SqlDataReader
        reader1 = SqlComm1.ExecuteReader()
        While reader1.Read()
            ComboBox1.Items.Add(reader1("HAFTA"))
        End While
        reader1.Close()
        cnn.Close()
        '-----------------------------------------------------------------------------------------
    ...
    Private Sub ComboBox2_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox2.SelectedIndexChanged
        ...
        Try
            ...
            cmd.CommandText = "SELECT* FROM dbo.EO_ALANSIS_HAFTA_URETIM1 WHERE YIL='" & ComboBox2.Text & "';"
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        Try
            ...
            cmd.Connection = cnn
            cmd.CommandType = CommandType.Text
            cmd.CommandText = "SELECT* FROM dbo.EO_ALANSIS_HAFTA_URETIM1 WHERE YIL='" & ComboBox2.Text & "' AND HAFTA='" & ComboBox1.Text & "' ;"
            da.SelectCommand = cmd
            da.Fill(ds)
            DataGridView1.DataSource = ds.Tables(0).DefaultView
        Catch ex As Exception
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        xlWorkSheet.Range("A1:E1").MergeCells = True
        xlWorkSheet.Range("A1").Font.Bold = True
        xlWorkSheet.Range("A1").Font.Size = 15
        xlWorkSheet.Range("A1").Value = "YIL :" + ComboBox2.Text + " HAFTA :" + ComboBox1.Text + " URETIM RAPORU"
        ...
        xlWorkSheet.Range("A2:E2").Interior.ColorIndex = 23
        ...
        xlWorkSheet.Range("A2:E2").Font.Bold = True
