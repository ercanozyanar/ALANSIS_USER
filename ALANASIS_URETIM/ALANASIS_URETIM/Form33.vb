...
Public Class Form33
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Try
            ...
            cmd.CommandText = "SELECT* FROM dbo.EO_ALANSIS_MPAKET_RAPOR WHERE TARIH BETWEEN '" & DateTimePicker4.Text & "' AND '" & DateTimePicker3.Text & "';"
        ...
        '-----------------------------------------------------------------------------------------
        cnn.Open()
        Dim mySelectQuery2 As String = "SELECT PARTINO FROM dbo.EO_ALANSIS_MPAKET_RAPOR WHERE TARIH BETWEEN '" & DateTimePicker4.Text & "' AND '" & DateTimePicker3.Text & "' GROUP BY PARTINO;"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        xlWorkSheet.Range("A1").Value = "Nar Paketleme Üretim Raporu (Mamul)"
        ...
        xlWorkSheet.Range("A2:V2").Interior.ColorIndex = 23
        ...
        xlWorkSheet.Range("F2").ColumnWidth = 20
        ...
        xlWorkSheet.Range("L2").ColumnWidth = 10
        xlWorkSheet.Range("M2").ColumnWidth = 30
        xlWorkSheet.Range("N2").ColumnWidth = 10
        xlWorkSheet.Range("O2").ColumnWidth = 30
        xlWorkSheet.Range("P2").ColumnWidth = 10
        xlWorkSheet.Range("Q2").ColumnWidth = 30
        xlWorkSheet.Range("R2").ColumnWidth = 15
        xlWorkSheet.Range("S2").ColumnWidth = 30
        xlWorkSheet.Range("T2").ColumnWidth = 16
        xlWorkSheet.Range("U2").ColumnWidth = 16
        xlWorkSheet.Range("V2").ColumnWidth = 16
        xlWorkSheet.Range("A2:V2").Font.Bold = True
    ...
    Private Sub ComboBox2_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox2.SelectedIndexChanged
        ...
        Try
            ...
            cmd.Connection = cnn
            cmd.CommandType = CommandType.Text
            cmd.CommandText = "SELECT* FROM EO_ALANSIS_MPAKET_RAPOR WHERE (TARIH BETWEEN '" & DateTimePicker4.Text & "' AND '" & DateTimePicker3.Text & "') AND PARTINO='" & ComboBox2.Text & "';"
            da.SelectCommand = cmd
            da.Fill(ds)
            DataGridView1.DataSource = ds.Tables(0).DefaultView
        Catch ex As Exception
